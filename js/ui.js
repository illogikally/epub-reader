...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=58';
import { scrollTocToCurrent } from './translate.js?v=58';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=58';
