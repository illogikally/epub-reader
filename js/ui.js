...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=57';
import { scrollTocToCurrent } from './translate.js?v=57';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=57';
