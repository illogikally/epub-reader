...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=63';
import { scrollTocToCurrent } from './translate.js?v=63';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=63';
