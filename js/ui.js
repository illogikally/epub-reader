...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=65';
import { scrollTocToCurrent } from './translate.js?v=65';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=65';
