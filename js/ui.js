...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=64';
import { scrollTocToCurrent } from './translate.js?v=64';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=64';
