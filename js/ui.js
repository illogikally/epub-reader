...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=60';
import { scrollTocToCurrent } from './translate.js?v=60';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=60';
