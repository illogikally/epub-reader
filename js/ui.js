...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=55';
import { scrollTocToCurrent } from './translate.js?v=55';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=55';
