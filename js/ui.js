...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=62';
import { scrollTocToCurrent } from './translate.js?v=62';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=62';
