...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=59';
import { scrollTocToCurrent } from './translate.js?v=59';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=59';
