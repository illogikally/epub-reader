...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=49';
import { scrollTocToCurrent } from './translate.js?v=49';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=49';
