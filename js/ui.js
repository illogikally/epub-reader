...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=61';
import { scrollTocToCurrent } from './translate.js?v=61';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=61';
