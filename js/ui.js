...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=54';
import { scrollTocToCurrent } from './translate.js?v=54';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=54';
