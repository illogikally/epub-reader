...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=56';
import { scrollTocToCurrent } from './translate.js?v=56';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=56';
