...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=50';
import { scrollTocToCurrent } from './translate.js?v=50';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=50';
