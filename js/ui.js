...
import { closeBook, createRendition, hideChrome, relayoutViewer } from './reader.js?v=66';
import { scrollTocToCurrent } from './translate.js?v=66';
import { syncDebugPanel, APP_VERSION } from './debug.js?v=66';
