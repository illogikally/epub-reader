...
import { applyChromeTheme } from './theme.js?v=20';
import { renderLibrary, initLibraryEvents, setBookOpener } from './library.js?v=20';
import { openBookFromDb, initReaderEvents } from './reader.js?v=20';
import { initTranslateEvents } from './translate.js?v=20';
import { initUI } from './ui.js?v=20';
import { dbGet } from './state.js?v=20';
import { syncDebugPanel } from './debug.js?v=20';
