...
import { applyChromeTheme } from './theme.js?v=42';
import { renderLibrary, initLibraryEvents, setBookOpener } from './library.js?v=42';
import { openBookFromDb, initReaderEvents } from './reader.js?v=42';
import { initTranslateEvents } from './translate.js?v=42';
import { initUI } from './ui.js?v=42';
import { initSyncUI, initDropboxSettings, requestSync } from './sync.js?v=42';
import { dbGet } from './state.js?v=42';
import { syncDebugPanel } from './debug.js?v=42';
