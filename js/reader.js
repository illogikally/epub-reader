...
import { applyBookTheme, injectBookStyle, alignToLineGrid } from './theme.js?v=59';
import {
...
} from './translate.js?v=59';
import { renderLibrary } from './library.js?v=59';
import {
  initTouchSelection, clearTouchSelection, onBookSwipe, onBookTap,
} from './touchselect.js?v=59';
import { dbg } from './debug.js?v=59';
