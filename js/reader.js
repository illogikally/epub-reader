...
import { applyBookTheme, injectBookStyle, alignToLineGrid } from './theme.js?v=56';
import {
...
} from './translate.js?v=56';
import { renderLibrary } from './library.js?v=56';
import {
  initTouchSelection, clearTouchSelection, onBookSwipe, onBookTap,
} from './touchselect.js?v=56';
import { dbg } from './debug.js?v=56';
